...
export default function HeroSection(){
    return (
        <section className="bg-white text-gray-600 min-w-full h-1/5 mt-4 rounded-lg">
            <div
                ...
                <div className="flex flex-wrap justify-center">
                    <button
                        className="px-8 py-3 m-2 text-lg font-semibold rounded bg-amber-600 text-white"
                    >
                        View Products
                    </button>
                </div>
